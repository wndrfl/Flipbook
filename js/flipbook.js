;(function( $, window, document, undefined ) {
	...
	Plugin.prototype.play = function() {
		var self = this;
		this.isPlaying = true;
		var interval = 1000/this.options.frameRate;
	...
	Plugin.prototype.showImage = function(i) {
		...
		if(this.prevFrame) {
			this.parentElement.children('.flipbook-frame-'+this.prevFrame).hide();
		}

		this.parentElement.children('.flipbook-frame-'+i).css({
			'display':'block'
		});
	}
